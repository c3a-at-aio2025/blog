---
title: Linear Regression, Data Version Control, FEAST & Explainable AI (LIME & ANCHOR)
draft: false
...
## 1.7 Linear Regression Simulation
...
## 1.8 Mở rộng từ Linear Regression
...
## 1.9 Nói thêm về vector hoá: Tại sao nó lại hiệu quả?
...
5. Chạy script download dữ liệu
...
8. Thêm các artifact khác do DVC quản lý
...
9. Tạo local DVC storage và cấu hình remote mặc định
